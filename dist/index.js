...
require("./style.css");
var _sendLike = _interopRequireDefault(require("./modules/sendLike.js"));
var _getLike = _interopRequireDefault(require("./modules/getLike.js"));
var _getBaseData = _interopRequireDefault(require("./modules/getBaseData.js"));
var _commentPopUp = _interopRequireDefault(require("./modules/commentPopUp.js"));
var _mealCounter = require("./modules/mealCounter.js");
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          arrayOfMeals = _context.sent;
          _context.next = 6;
          return (0, _getLike["default"])();
        case 6:
          dataLikes = _context.sent;
          arrayOfMeals.forEach(function (item, id) {
            ...
            commentBtn.addEventListener('click', function () {
              (0, _commentPopUp["default"])(item.idMeal);
...
document.addEventListener('DOMContentLoaded', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  ...
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        _context2.next = 2;
        return (0, _mealCounter.mealcounter)();
      case 2:
        num = _context2.sent;
        _context2.next = 5;
        return showMeals();
      case 5:
        (0, _mealCounter.showCount)(num);
      case 6:
      case "end":
