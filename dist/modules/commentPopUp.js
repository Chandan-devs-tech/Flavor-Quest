...
var _setComment = require("./setComment.js");
...
var popupWindow = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
    var mainContainer, result, data, mealDetails, overlay, footer, popupContainer, closeButton, img, popupImage, imgDescipDiv, popupFoodName, formTitle, form, nameInput, yourInsightInput, submit, commentHeader, userCommentsDiv, allComments, closePopup;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          ...
          img.src = "".concat(mealDetails.strMealThumb);
          popupImage.appendChild(img);
          imgDescipDiv = document.createElement('div');
          imgDescipDiv.classList.add('img-desc-container');
          imgDescipDiv.innerHTML = "<p>Area : ".concat(mealDetails.strArea, " </p>\n  <p>Measure : ").concat(mealDetails.strMeasure2, "</p>\n  <p>Ingedients : ").concat(mealDetails.strIngredient1, " </p>\n  <p>Category: ").concat(mealDetails.strCategory, "</p>\n ");
          popupFoodName = document.createElement('h3');
          popupFoodName.className = 'food-name';
          popupFoodName.textContent = "".concat(mealDetails.strMeal);
          ...
          yourInsightInput = document.createElement('textarea');
          ...
          commentHeader = document.createElement('h4');
          commentHeader.className = 'comment-header';
          // commentHeader.innerHTML = '(Counter coming soon) Comments';
          userCommentsDiv = document.createElement('div');
          userCommentsDiv.classList.add('comments-container');
          _context2.next = 49;
          return (0, _setComment.getComments)(id);
        case 49:
          allComments = _context2.sent;
          (0, _setComment.displayComment)(allComments, userCommentsDiv, commentHeader);
          ...
          submit.addEventListener('click', /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
              var nameVal, insightVal, allComments;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    event.preventDefault();
                    nameVal = nameInput.value;
                    insightVal = yourInsightInput.value;
                    (0, _setComment.setComment)(id, nameVal, insightVal);
                    _context.next = 6;
                    return (0, _setComment.getComments)(id);
                  case 6:
  ...
  return function popupWindow(_x) {
